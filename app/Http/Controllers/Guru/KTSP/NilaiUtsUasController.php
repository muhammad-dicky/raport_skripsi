...
class NilaiUtsUasController extends Controller
{
    ...
    public function store(Request $request)
    {
        if (is_null($request->anggota_kelas_id)) {
            ...
            return redirect('guru/nilaiutsuas')->with('toast_success', 'Data nilai STS & SAS berhasil disimpan.');
        }
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('guru/nilaiutsuas')->with('toast_success', 'Data nilai STS & SAS berhasil diedit.');
    }
