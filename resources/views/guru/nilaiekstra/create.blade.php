                      ...
                      <table class="table table-bordered table-striped">
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td>
                              <textarea class="form-control" name="deskripsi[]" rows="2" minlength="30" maxlength="200" required oninvalid="this.setCustomValidity('Capaian Kompetensi harus berisi antara 20 s/d 100 karekter')" oninput="setCustomValidity('')">{{$anggota_ekstrakulikuler->deskripsi}}</textarea>
                            </td>
                          </tr>
                          @endforeach
                        </tbody>
