          ...
          <div class="card card-default">
            ...
            <div class="card-body">
              ...
              <div class="callout callout-success">
                ...
                <span class="text-danger"><i class="icon fas fa-ban"></i> Belum ditemukan data KKTP mapel.</span>
                @elseif($count_pembelajaran == $count_kkm)
                <span class="text-success"><i class="icon fas fa-check"></i> Seluruh data KKTP mapel valid.</span>
                @else
                <span class="text-danger"><i class="icon fas fa-ban"></i> Terdapat {{$count_pembelajaran-$count_kkm}} pembelajaran belum ditentukan KKTP.</span>
                @endif
              </div>
              <div class="callout callout-success">
