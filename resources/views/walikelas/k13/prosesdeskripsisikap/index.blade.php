                  ...
                  <table class="table table-bordered table-striped">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                          <textarea class="form-control" name="deskripsi_spiritual[]" rows="4" minlength="30" maxlength="255" required oninvalid="this.setCustomValidity('Capaian Kompetensi harus berisi antara 20 s/d 100 karekter')" oninput="setCustomValidity('')">Memiliki sikap spiritual {{$anggota_kelas->nilai_spiritual}}, antara lain
Konsisten dalam <?php $no = 0; ?> @foreach($anggota_kelas->data_butir_spiritual->sortBy('k13_butir_sikap.butir_sikap') as $butir_spiritual)<?php $no++; ?>@if($no == $anggota_kelas->count_spiritual)dan @endif{{$butir_spiritual->k13_butir_sikap->butir_sikap}}@if($no == $anggota_kelas->count_spiritual). @else, @endif @endforeach
                        ...
                        <td>
                          <textarea class="form-control" name="deskripsi_sosial[]" rows="4" minlength="30" maxlength="255" required oninvalid="this.setCustomValidity('Capaian Kompetensi harus berisi antara 20 s/d 100 karekter')" oninput="setCustomValidity('')">Memiliki sikap sosial {{$anggota_kelas->nilai_sosial}}, antara lain
