                  ...
                  <form action="{{ route('prestasi.store') }}" method="POST">
                    ...
                    <div class="modal-body">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                          <textarea class="form-control" name="deskripsi" placeholder="Capaian Kompetensi Prestasi" rows="3" minlength="20" maxlength="200" required oninvalid="this.setCustomValidity('Capaian Kompetensi harus berisi antara 20 s/d 100 karekter')" oninput="setCustomValidity('')"></textarea>
                        </div>
                      </div>
                ...
                <table id="example1" class="table table-valign-middle table-hover">
                  <thead>
                    <tr>
                      ...
                      <th>Capaian Kompetensi Prestasi</th>
