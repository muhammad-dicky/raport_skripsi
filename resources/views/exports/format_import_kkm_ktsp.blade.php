...
<head>
  ...
  <title>FORMAT IMPORT KKTP MERDEKA</title>
</head>
...
<body>
  <table>
    <thead>
      <tr>
        <td colspan="6">
          <strong>FORMAT IMPORT KKTP MATA PELAJARAN TAHUN PELAJARAN {{$tapel->tahun_pelajaran}}
            @if($tapel->semester == 1)
            GANJIL
            @else
            GENAP
      ...
      <tr>
        <td colspan="6">- Isikan KKTP dengan angka antara 0 s/d 100</td>
      </tr>
    </thead>
    <tbody>
      <!-- Pembelajaran  -->
